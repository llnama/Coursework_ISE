...
pd_tplusb.to_csv(os.path.join(dataset_folder, 'Title+Body.csv'), index=False, columns=["id", "Number", "sentiment", "text"])
...
# 1) Data file to read
datafile = os.path.join(dataset_folder, 'Title+Body.csv')
